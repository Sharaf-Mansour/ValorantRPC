...
public class VDRPC
{
    ...
    public static void PrepareDiscordRPC()
    {
        ...
        Client.OnReady += (sender, e) =>LogFile($"Discord is Ready! user {DUsername = e.User.Username}");
        Client.OnPresenceUpdate += (sender, msg) => LogFile("Discord Presence Updated!");
